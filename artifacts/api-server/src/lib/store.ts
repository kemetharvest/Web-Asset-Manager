/**
 * In-memory student data store with O(1) seat-number lookup
 * and indexed name search for fast partial matching.
 */
...
class StudentStore {
  ...
  searchByName(query: string, page: number, limit: number): { students: Student[]; total: number } {
